...
*/
function getYoutubePlaylistDataXml($ytlist, $cnt = 16, $cache_life = 3600) {
    # файл, содержащий копию ленты
    $cache_file = dirname(__FILE__) . DIRECTORY_SEPARATOR . $ytlist . '.json';

    # Ключ для запросов
    $api_key = 'AIzaSyBIMb3as0q8QfsM-joR7W5FYOL7tznVCzE';
...
$playlist_id = 'PL363QX7S8MfSxcHzvkNEqMYbOyhLeWwem';
